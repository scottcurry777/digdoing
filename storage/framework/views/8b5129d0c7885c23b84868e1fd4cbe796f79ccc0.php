...
<?php echo e($interest->name); ?> <?php if($locationName): ?> <?php echo e($locationAdverb); ?> <?php echo e($locationName); ?> <?php endif; ?>
...
<?php $__env->startSection('main-content'); ?>
    ...
    Main Body.  Posts related to this activity.
    ...
    <script>
        ...
        */
        ...
        suggestLocation.on('click tap touch', '.suggest-location', function() {
            ...
            window.location.href = "/<?php echo e($interest->slug); ?>/discussion/" + $(this).data('country') + "/" + $(this).data('state') + "/" + $(this).data('slug');
        });
        ...
        $('select').on('change', function() {
            if ($(this).val()) {
                ...
                window.location.href = "/<?php echo e($interest->slug); ?>/discussion/" + $(this).find(':selected').data('country') + "/" + $(this).val();
            }
        });
    </script>
    
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.interest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scott4jesus/Websites/digdoing.com/resources/views/interest/interest.blade.php ENDPATH**/ ?>