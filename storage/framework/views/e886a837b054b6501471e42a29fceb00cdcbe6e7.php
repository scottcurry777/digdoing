...
<?php echo e($interest->name); ?> Together <?php if($locationName): ?> <?php echo e($locationAdverb); ?> <?php echo e($locationName); ?> <?php endif; ?>
    ...
    <script>
        ...
        */
        ...
        suggestLocation.on('click tap touch', '.suggest-location', function() {
            ...
            window.location.href = "/<?php echo e($interest->slug); ?>/together/" + $(this).data('country') + "/" + $(this).data('state') + "/" + $(this).data('slug');
        });
        ...
        $('select').on('change', function() {
            if ($(this).val()) {
                ...
                window.location.href = "/<?php echo e($interest->slug); ?>/together/" + $(this).find(':selected').data('country') + "/" + $(this).val();
            }
        });
    </script>
    
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.interest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scott4jesus/Websites/digdoing.com/resources/views/interest/together.blade.php ENDPATH**/ ?>