...
unset($__errorArgs, $__bag); ?>
    ...
    <div style="margin-bottom: 30px;">
        <a href="<?php echo e(url('/login/social/facebook')); ?>" class="button button-blue" style="margin: 10px;">Login with Facebook</a>
    </div>
    <div style="margin-bottom: 30px;">
        <a href="<?php echo e(url('/login/social/google')); ?>" class="button" style="margin: 10px;">Login with Google</a>
    </div>
    -->

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scott4jesus/Websites/digdoing.com/resources/views/auth/login.blade.php ENDPATH**/ ?>