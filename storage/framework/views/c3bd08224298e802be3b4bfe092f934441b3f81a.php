        ...
        <div style="display: flex; flex-flow: column; justify-content: center; align-items: center; width: 100%;">
            ...
            <div style="display: flex; flex-flow: row; justify-content: space-between; align-items: stretch; width: 100%; max-width: 718px;">
                <div style="flex: 1 1 15%; display: flex; justify-content: flex-end; align-items: center; margin: 10px; text-align: center;">
                    <?php if(Session::get('color_scheme') == 'light'): ?> <img src="/images/home_light_active.png" width="40px;" height="40px;">  <?php else: ?> <img src="/images/home_active.png" width="40px;" height="40px;">  <?php endif; ?>
                </div>
            ...
            <div style="display: flex; flex-flow: row; justify-content: space-between; align-items: stretch; width: 100%; max-width: 718px;">
                <div style="flex: 1 1 15%; display: flex; justify-content: flex-end; align-items: center; margin: 10px; text-align: center;">
                    <?php if(Session::get('color_scheme') == 'light'): ?> <img src="/images/interests_light_active.png" width="40px;" height="40px;">  <?php else: ?> <img src="/images/interests_active.png" width="40px;" height="40px;">  <?php endif; ?>
                </div>
                <div style="flex: 1 1 85%; display: flex; justify-content: flex-start; align-items: center; min-height: 60px; margin: 10px 20px 10px 10px; text-align: left;">
            ...
            <div style="display: flex; flex-flow: row; justify-content: space-between; align-items: stretch; width: 100%; max-width: 718px;">
                <div style="flex: 1 1 15%; display: flex; justify-content: flex-end; align-items: center; margin: 10px; text-align: center;">
                    <?php if(Session::get('color_scheme') == 'light'): ?> <img src="/images/locations_light_active.png" width="40px;" height="40px;">  <?php else: ?> <img src="/images/locations_active.png" width="40px;" height="40px;">  <?php endif; ?>
                </div>
                <div style="flex: 1 1 85%; display: flex; justify-content: flex-start; align-items: center; min-height: 60px; margin: 10px 20px 10px 10px; text-align: left;">
            ...
            <div style="display: flex; flex-flow: row; justify-content: space-between; align-items: stretch; width: 100%; max-width: 718px;">
                <div style="flex: 1 1 15%; display: flex; justify-content: flex-end; align-items: center; margin: 10px; text-align: center;">
                    <?php if(Session::get('color_scheme') == 'light'): ?> <img src="/images/calendar_light_active.png" width="40px;" height="40px;">  <?php else: ?> <img src="/images/calendar_active.png" width="40px;" height="40px;">  <?php endif; ?>
                </div>
                <div style="flex: 1 1 85%; display: flex; justify-content: flex-start; align-items: center; min-height: 60px; margin: 10px 20px 10px 10px; text-align: left;">
            ...
            <div style="display: flex; flex-flow: row; justify-content: space-between; align-items: stretch; width: 100%; max-width: 718px;">
                <div style="flex: 1 1 15%; display: flex; justify-content: flex-end; align-items: center; margin: 10px; text-align: center;">
                    <?php if(Session::get('color_scheme') == 'light'): ?> <img src="/images/alerts_light_active.png" width="40px;" height="40px;">  <?php else: ?> <img src="/images/alerts_active.png" width="40px;" height="40px;">  <?php endif; ?>
                </div>
                <div style="flex: 1 1 85%; display: flex; justify-content: flex-start; align-items: center; min-height: 60px; margin: 10px 20px 10px 10px; text-align: left;">
            ...
            <div style="display: flex; flex-flow: row; justify-content: space-between; align-items: stretch; width: 100%; max-width: 718px;">
                <div style="flex: 1 1 15%; display: flex; justify-content: flex-end; align-items: center; margin: 10px; text-align: center;">
                    <?php if(Session::get('color_scheme') == 'light'): ?> <img src="/images/user_light_active.png" width="40px;" height="40px;">  <?php else: ?> <img src="/images/user_active.png" width="40px;" height="40px;">  <?php endif; ?>
                </div>
                <div style="flex: 1 1 85%; display: flex; justify-content: flex-start; align-items: center; min-height: 60px; margin: 10px 20px 10px 10px; text-align: left;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scott4jesus/Websites/digdoing.com/resources/views/index.blade.php ENDPATH**/ ?>