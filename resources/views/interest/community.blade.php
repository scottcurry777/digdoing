...
@section('title')
{{ $interest->name }} Community @if($locationName) {{ $locationAdverb }} {{ $locationName }} @endif
@endsection
    ...
    <script>
        ...
        */
        ...
        suggestLocation.on('click tap touch', '.suggest-location', function() {
            ...
            window.location.href = "/{{ $interest->slug }}/community/" + $(this).data('country') + "/" + $(this).data('state') + "/" + $(this).data('slug');
        });
        ...
        $('select').on('change', function() {
            if ($(this).val()) {
                ...
                window.location.href = "/{{ $interest->slug }}/community/" + $(this).find(':selected').data('country') + "/" + $(this).val();
            }
        });
    </script>
